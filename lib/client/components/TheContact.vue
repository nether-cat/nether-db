            ...
            <b-row>
              ...
              <b-col>
                <b-form-group label="Surname:">
                  <b-form-input prepend="Surname:" v-model="contact.surname"></b-form-input>
                </b-form-group>
              </b-col>
            </b-row>
            <b-row>
              <b-col>
                <b-form-group label="Your email:">
                  <b-form-input prepend="Email:" v-model="contact.email"></b-form-input>
                </b-form-group>
              </b-col>
              <b-col>
                <b-form-group label="Your institution:">
                  <b-form-input prepend="Name:" v-model="contact.institution"></b-form-input>
                </b-form-group>
              </b-col>
            </b-row>
